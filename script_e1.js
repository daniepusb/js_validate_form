...
function cargaInicial(){
    let btn__guardar            = document.getElementById("guardar__cantidad__nombres");
    let btn__mostrar__resultado = document.getElementById("mostrar__resultado");

    btn__guardar.addEventListener("click", function(event){
        event.preventDefault();
        guardarNumero();
    });
    btn__mostrar__resultado.addEventListener("click", function(event){
        event.preventDefault();
        mostrarNombres();
    });
}
